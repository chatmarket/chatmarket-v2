...
const plans = {
  ...
  basic: {
    ...
    description: "1対1の有料ビデオ通話で収益化。プログレッシブ・インセンティブで売上が伸びるほど還元率もアップ！",
    features: [
      { title: "1対1の有料ビデオ通話機能", desc: "視聴者と1対1の有料ビデオ通話。自由な料金設定が可能です。" },
      { title: "通話料金：15分 ¥150〜（自由設定）", desc: "最低¥150から自由に設定できます。" },
