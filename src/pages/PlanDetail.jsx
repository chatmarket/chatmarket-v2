...
const plans = {
  ...
  basic: {
    ...
    features: [
      { title: "1対1 双方向ビデオ通話 と 1対多 ライブ配信の選択", desc: "配信開始時に「ライブ配信」か「ビデオ通話」かを選択できます。用途に合わせて使い分け可能。" },
      { title: "通話・配信料金：15分 ¥150〜（自由設定）", desc: "最低¥150から自由に設定できます。" },
      { title: "アーカイブ保存・有料公開（¥1〜）", desc: "配信・通話終了後に録画を保存し、非公開記録または¥1〜の有料動画として販売できます。" },
      { title: "肖像権同意チェック付き安全公開", desc: "アーカイブを有料公開する際は、通話相手の肖像権に関する同意確認チェックが必須です。" },
  ...
  "call-anser": {
    ...
    features: [
      { title: "1対1の双方向有料通話（15分毎に¥150〜）", desc: "発信・受信どちらも課金設定が可能な双方向通話。" },
      { title: "30分×4回/日 無料通話", desc: "毎日30分×4回分の無料通話枠が付きます。" },
      { title: "エールコイン受け取り機能", desc: "通話中に視聴者・相手からエールコインを受け取れます。" },
      { title: "有料インタビュー", desc: "「有料でインタビューさせてください」など、コンテンツ制作に活用できます。" },
      { title: "推し活・ファンとの交流", desc: "推しとの特別な時間を有料で提供・体験。" },
  ...
  ppv: {
    ...
    features: [
      ...
      { title: "配信料金：¥1〜（自由設定）", desc: "チケット料金は¥1から自由に設定できます。" },
