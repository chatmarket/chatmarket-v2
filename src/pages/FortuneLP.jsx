          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center">
            ...
            >
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  <Star className="w-4 h-4" style={{ color: MYSTIC.gold }} />
                  <p className="text-xs tracking-[0.2em] uppercase font-bold" style={{ color: MYSTIC.gold }}>
                    プロの占い師になる
                  </p>
                </div>
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-black leading-tight">
                  自宅から、<br />
                  <span style={{
                    background: `linear-gradient(135deg, ${MYSTIC.goldLight}, ${MYSTIC.gold})`,
                    WebkitBackgroundClip: "text",
                    WebkitTextFillColor: "transparent",
                  }}>
                    月収100万円超
              ...
              <p className="text-base text-white/70 leading-relaxed">
                あなたの霊感・鑑定力をオンラインで活かす。スマホ1台で、いつでもどこでも、好きな時間に鑑定できる。ファンとの直接的な繋がりが、圧倒的な収入を生む仕組みです。
              </p>
              <ul className="space-y-2 text-sm">
                {[
                  ...
                  <li key={i} className="flex items-center gap-3">
                    <span className="w-1.5 h-1.5 rounded-full" style={{ background: MYSTIC.gold }} />
            ...
            >
              <div className="relative rounded-3xl overflow-hidden"
                ...
                <img
                  src="https://media.base44.com/images/public/69c1b541d5db3555833124aa/9f432c9e8_generated_image.png"
                  alt="オンラインで占いを受ける女性"
