...
const PLANS = [
  ...
  },
  {
    ...
    features: ["Amazon Chime SDK による超低遅延ビデオ通話", "1対1 有料ビデオ通話（配信者が料金設定・申込者が支払い）", "通話料金：15分 150円〜（SD/HD/FHD 画質連動）", "スケジュール制・事前申し込み方式", "無料通話枠なし・有料通話のみ", "プログレッシブ・インセンティブに自動参加（月間売上で還元率最大95%）", "視聴者からエールコイン受取"],
  },
  {
    id: "call-anser",
    icon: Phone,
    ...
    features: [
      ...
      "通話料金設定：15分 150円〜上限なし（配信者が自由に設定）",
