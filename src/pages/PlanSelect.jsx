...
const PLANS = [
  ...
  },
  {
    ...
    features: ["制作動画の販売機能", "動画１時間以内、1動画150円〜（自由設定）", "生配信アーカイブ販売機能", "視聴者からエールコイン受取"],
  },
  {
    id: "ppv",
    icon: Radio,
    ...
    features: ["1対多数の有料ライブ配信", "配信料金：自由設定（将来的に最低設定金額を低く設定できるようにしていきます）", "視聴者からエールコイン受取", "ライブ配信アーカイブ"],
  },
  {
    id: "mini-school",
    icon: GraduationCap,
