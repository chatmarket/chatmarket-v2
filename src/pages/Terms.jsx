  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="bg-card border border-border/50 rounded-2xl p-6 space-y-8">
        ...
        <Section title="第12条（アカウントの停止・解約）">
        ...
        <Section title="第16条（秘密保持）">
          <p>クリエイター（配信者・ライバー・占い師・講師等、本サービスを通じてサービスを提供する者。以下「クリエイター」）は、本条の秘密保持義務を遵守するものとします。本条の義務は、本規約への同意時点から発生し、アカウント退会後も3年間存続します。</p>
          <ul className="list-disc list-inside space-y-2 pl-2 mt-2">
            <li>
              <strong>システム・ノウハウの秘密保持：</strong>
              クリエイターは、ChatMarketのシステム構成、アルゴリズム、マッチングロジック、収益計算方式、内部手数料構造、運営ノウハウ、未公開機能、管理画面の仕様その他技術的・営業上の秘密情報（以下「システム情報」）を、第三者に開示・漏洩・転用してはなりません。競合他社への提供、SNSでの公開、第三者への教示を含みます。
            </li>
            <li>
              <strong>相談内容・個人情報の秘密保持：</strong>
              クリエイターは、本サービスを通じて知り得たユーザー（相談者・視聴者・ファン等）の相談内容、個人情報、悩み、家族構成、健康状態、財産状況その他の一切のプライバシー情報（以下「相談情報」）を、当該ユーザーの明示的な同意なく第三者に開示・漏洩してはなりません。SNSへの投稿、他者への口頭伝達、出版物への掲載等を問いません。
            </li>
            <li>
              <strong>違反時の措置：</strong>
              本条に違反した場合、当社はアカウントを即時停止・削除し、損害賠償を請求できるものとします。また、当社は差止請求その他必要な法的措置を取ることができます。本条の違反により当社または第三者に生じた損害はすべてクリエイターが賠償するものとします。
            </li>
          </ul>
          <p className="mt-2 text-xs text-muted-foreground">※ 本条はNDA（秘密保持契約）と同等の法的効力を有します。登録申請時の利用規約同意チェックをもって、本条への個別同意が成立するものとします。</p>
        </Section>
